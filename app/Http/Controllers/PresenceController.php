...
class PresenceController extends Controller
{
    ...
    public function checkIn(Request $request): RedirectResponse
    {
        ...
        // Ambil toleransi dari jadwal (default 0 jika null)
        ...
        try {
            PresenceLog::create([
                ...
                'id_store' => $storeId,
                'id_presence_schedule' => $schedule->id_presence_schedule,
                'check_in_time' => $now,
                'check_out_time' => null,
                'status' => $status,
                'notes' => $notes,
                'ip_address' => $karyawanIp,
                'late_minutes' => $lateMinutes, // Simpan jumlah menit keterlambatan
            ]);
