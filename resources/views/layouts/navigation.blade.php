<div class="flex flex-col h-full">
    ...
    <nav class="flex-1 overflow-y-auto scrollbar-hide">
        ...
        @if (Auth::user()->role == 'admin')
            ...
            <a href="{{ route('pos.index') }}" class="{{ $linkClasses }} {{ request()->routeIs('pos.*') && !request()->routeIs('pos.history') ? $activeClasses : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="{{ $iconClasses }}">
        ...
        @else
            ...
            <a href="{{ route('pos.history') }}" 
               class="{{ $linkClasses }} {{ request()->routeIs('pos.history') ? $activeClasses : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="{{ $iconClasses }}">
