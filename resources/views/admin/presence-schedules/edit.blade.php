                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <form method="POST" action="{{ route('admin.presence-schedules.update', $schedule->id_presence_schedule) }}">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="number" name="late_threshold" id="late_threshold" value="{{ old('late_threshold', $schedule->late_threshold) }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" oninput="this.value = this.value.replace(/^0+(?=\d)/, '')" required>
