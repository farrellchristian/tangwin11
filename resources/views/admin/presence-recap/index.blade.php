                ...
                <div class="block md:hidden divide-y divide-gray-100">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex items-center gap-2 pt-1">
                            <a href="{{ route('admin.presence-recap.edit', $log->id_presence_log) }}" class="flex-1 inline-flex justify-center items-center gap-1.5 py-2 px-3 bg-amber-50 text-amber-600 text-[11px] font-bold rounded-lg border border-amber-200 hover:bg-amber-100 transition">
                        ...
                        <x-modal name="confirm-deletion-{{ $log->id_presence_log }}" focusable>
                            <form method="post" action="{{ route('admin.presence-recap.destroy', $log->id_presence_log) }}" class="p-6">
                                @csrf
                                @method('delete')
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <x-modal name="confirm-deletion-{{ $log->id_presence_log }}" focusable>
                                        <form method="post" action="{{ route('admin.presence-recap.destroy', $log->id_presence_log) }}" class="p-6">
                                            ...
                                            <p class="mt-1 text-sm text-gray-600">
                                                Data presensi {{ $log->employee->employee_name }} pada {{ $log->check_in_time->format('d M Y') }} akan dihapus (Soft Delete).
                                            </p>
