            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-100">
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.products.update', $product->id_product) }}"> @csrf
                        ...
                        <div class="mt-4"
                             x-data="{
                                 formattedStock: '{{ old('stock_available') ? number_format(old('stock_available'), 0, ',', '.') : ($product->stock_available ? number_format($product->stock_available, 0, ',', '.') : '') }}',
                                 rawStock: '{{ old('stock_available', $product->stock_available) }}',
                                 formatStock() {
