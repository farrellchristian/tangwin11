                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.expenses.update', $expense->id_expense) }}">
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ request('back_url') ? request('back_url') : route('admin.expenses.index', request()->query()) }}" class="text-sm text-gray-600 hover:text-gray-900 mr-4">
                                Batal
                            </a>
