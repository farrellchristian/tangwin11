    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0 mb-4">
                ...
                {{-- Perbaikan Responsif: Tambah w-full sm:w-auto --}}
                <form method="GET" action="{{ route('admin.services.index') }}" class="flex items-center w-full sm:w-auto">
                ...
                {{-- Perbaikan Responsif: Tambah w-full sm:w-auto dan justify-center --}}
                                ...
                                @forelse ($services as $service)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form action="{{ route('admin.services.destroy', $service->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                @csrf
                                                @method('DELETE')
