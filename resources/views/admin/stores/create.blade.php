<x-app-layout>
    ...
    <div class="py-6 sm:py-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-4">
                <a href="{{ route('admin.stores.index') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                ...
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.stores.store') }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="store_name" id="store_name" value="{{ old('store_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required autofocus>
                            @error('store_name')
                        ...
                        <div class="mt-6 border-t pt-4">
                             ...
                             <div class="mt-4">
                                ...
                                <input type="text" name="store_ip_address" id="store_ip_address" value="{{ old('store_ip_address') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Contoh: 192.168.1.1">
                             ...
                             <div class="mt-4">
                                ...
                                <select id="enable_ip_validation" name="enable_ip_validation" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    <option value="0" {{ old('enable_ip_validation', '0') == '0' ? 'selected' : '' }}>Tidak (Default)</option>
                                    <option value="1" {{ old('enable_ip_validation') == '1' ? 'selected' : '' }}>Ya, Aktifkan</option>
                                </select>
