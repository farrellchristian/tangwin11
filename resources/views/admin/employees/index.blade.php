    ...
    <div class="py-6 sm:py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-4 text-sm text-gray-500">
                Kelola data karyawan, toko penempatan, dan status kepegawaian.
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0 mb-4">
                ...
                <form method="GET" action="{{ route('admin.employees.index') }}"
                    ...
                    <button type="submit"
                        class="w-full sm:w-auto px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-medium hover:bg-indigo-700 flex-shrink-0">
                        Filter
                    </button>
                </form>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 sm:p-6 text-gray-900">
                                ...
                                @forelse ($employees as $employee)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $employee->employee_name }}
                                            </div>
                    ...
                    <div class="block md:hidden space-y-4">
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm flex flex-col space-y-3">
                                ...
                                <div class="flex flex-col space-y-1 text-sm text-gray-600">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="text-xs text-gray-500">{{ $employee->join_date->format('d M Y') }}</span>
                                    </div>
                                </div>
                        ...
                        @empty
                            <div
                                class="text-center py-6 text-gray-500 text-sm border border-gray-200 rounded-lg bg-gray-50">
                                Data karyawan belum tersedia.
                            </div>
                        @endforelse
                    </div>
