    ...
    <div class="py-8" x-data="{ search: '' }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-800">{{ number_format($statsTotal) }}</h3>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-100">
                ...
                <form method="GET" action="{{ route('admin.reservation.index') }}" class="p-5 border-b border-gray-200 bg-gray-50 flex flex-col items-center gap-4 xl:flex-row xl:justify-between">

                    {{-- KIRI: Date Range & Toko --}}
                    <div class="flex flex-col md:flex-row gap-3 w-full xl:w-auto">
                        <div class="flex items-center bg-white border border-gray-300 rounded-lg overflow-hidden w-full md:w-auto">
                            <input type="date" name="start_date" value="{{ $startDate }}" class="border-none text-sm text-gray-700 focus:ring-0 w-full md:w-36 bg-transparent" title="Mulai Tanggal">
                            <span class="text-gray-400 px-1">-</span>
                            <input type="date" name="end_date" value="{{ $endDate }}" class="border-none text-sm text-gray-700 focus:ring-0 w-full md:w-36 bg-transparent" title="Sampai Tanggal">
                        </div>

                        <select name="store_id" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm text-sm w-full md:w-48">
                        ...
                        <select name="status" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm text-sm w-full md:w-40">
                    ...
                    <div class="flex gap-2 w-full xl:w-auto">
                        <div class="relative w-full xl:w-64">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" class="block w-full p-2.5 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-indigo-500 focus:border-indigo-500" placeholder="Cari nama/HP...">
                        </div>
                        <button type="submit" class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2">
                            Filter
                        </button>
                        <a href="{{ route('admin.reservation.index') }}" class="text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2">
                            Reset
                        </a>
                    </div>
                </form>
