            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ml-14 lg:ml-0">
                <div>
                    ...
                    <p class="text-slate-400 mt-2 text-sm">
                        Monitoring performa bisnis & keuangan per <span class="text-white font-semibold">{{ \Carbon\Carbon::now()->locale('id')->translatedFormat('l, d F Y') }}</span>.
                    </p>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border-b-4 border-purple-500 transform transition hover:-translate-y-1 hover:shadow-xl">
                <div class="flex justify-between items-center mb-4">
                    <div class="p-3 bg-purple-50 rounded-xl text-purple-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 lucide lucide-users-icon lucide-users">
