            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-100">
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.foods.update', $food->id_food) }}">
                        ...
                        <div class="mt-4"
                             x-data="{
                                 formattedStock: '{{ old('stock_available') ? number_format(old('stock_available'), 0, ',', '.') : ($food->stock_available ? number_format($food->stock_available, 0, ',', '.') : '') }}',
                                 rawStock: '{{ old('stock_available', $food->stock_available) }}',
                                 formatStock() {
